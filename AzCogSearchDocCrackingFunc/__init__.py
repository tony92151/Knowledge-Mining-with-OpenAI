...
from utils import cosmos_helpers, cv_helpers, storage
...
def analyze_doc(data_dict):
    ...
    ret_dict["status"] = ""
    db_status = ""
    data_dict["text"] = remove_urls(
        data_dict["content"].replace("\n\n\n", "\n").replace("....", ".")
    )
    ...
    for re_str in re_strs:
        ...
        for m in matches:
            data_dict["text"] = data_dict["text"].replace(m, "")
...
def transform_value(value):
    ...
    return {"recordId": recordId, "data": ret_dict}
