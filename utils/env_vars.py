...
TRANSLATION_ENDPOINT = os.environ.get(
...
if TRANSLATION_API_KEY == "":
    TRANSLATION_API_KEY = COG_SERV_KEY
...
COG_VEC_SEARCH_API_VERSION = os.environ.get(
...
WEBSITE_MAX_DYNAMIC_APPLICATION_SCALE_OUT = int(
    os.environ.get("WEBSITE_MAX_DYNAMIC_APPLICATION_SCALE_OUT", "1")
)
...
CHOSEN_QUERY_EMB_MODEL = os.environ.get(
...
ADA_002_EMBEDDING_MODEL = os.environ.get(
...
DAVINCI_003_MODEL_MAX_TOKENS = int(
    os.environ.get("DAVINCI_003_MODEL_MAX_TOKENS", "4000")
)
DAVINCI_003_EMB_MAX_TOKENS = int(os.environ.get("DAVINCI_003_EMB_MAX_TOKENS", "2047"))
DAVINCI_003_COMPLETIONS_MODEL = os.environ.get(
    "DAVINCI_003_COMPLETIONS_MODEL", "text-davinci-003"
)
DAVINCI_003_EMBEDDING_MODEL = os.environ.get(
    "DAVINCI_003_EMBEDDING_MODEL", "text-search-davinci-doc-001"
)
DAVINCI_003_QUERY_EMB_MODEL = os.environ.get(
...
GPT35_TURBO_COMPLETIONS_MAX_TOKENS = int(
    os.environ.get("GPT35_TURBO_COMPLETIONS_MAX_TOKENS", "8193")
)
GPT35_TURBO_COMPLETIONS_ENCODING = os.environ.get(
...
GPT4_COMPLETIONS_MODEL_MAX_TOKENS = int(
    os.environ.get("GPT4_COMPLETIONS_MODEL_MAX_TOKENS", "8192")
)
GPT4_32K_COMPLETIONS_MODEL_MAX_TOKENS = int(
    os.environ.get("GPT4_32K_COMPLETIONS_MODEL_MAX_TOKENS", "32768")
)
